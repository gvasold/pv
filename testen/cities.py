...
def filter_by_name(cities: 'List[Dict[str, str]]', needle:str, case_sensitive=False) -> List[Dict[str, str]]:
    """
...
def filter_by_population(cities: 'list[dict[str, str]]', min_population) -> List[Dict[str, str]]:
    """
